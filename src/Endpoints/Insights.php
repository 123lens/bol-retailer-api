...
class Insights extends BaseEndpoint
{
     ...
     * Get Offer Insights
     *
     * @see https://api.bol.com/retailer/public/redoc/v6#operation/get-offer-insights
     ...
     * @see https://api.bol.com/retailer/public/redoc/v6#operation/get-performance-indicator
     * @param string $year
     * @param string $week
    ...
    /**
     * Get Sales Forecast
     * @see https://api.bol.com/retailer/public/redoc/v6#operation/get-sales-forecast
     * @param string $offerId
     * @param int $weeks
     * @return ForeCast
     */
    ...
    /**
     * Get Search Terms
     * @see https://api.bol.com/retailer/public/redoc/v6#operation/get-search-terms
     * @param string $term
     * @param string $period
     * @param int $numberOfPeriods
